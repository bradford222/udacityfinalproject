...
class StrutTestCase(unittest.TestCase):
    ...
    def test_get_provider_details_auth(self):
        ...
        res = make_request_with_auth(self, '/providers/1',
                                     method='GET', jwt=self.normalJWT)
        data = json.loads(res.data)
        ...
        # Test error case
        res = make_request_with_auth(self, '/providers/10000',
                                     method='GET', jwt=self.normalJWT)
        data = json.loads(res.data)
    ...
    def test_add_provider(self):
        ...
        # Test without logging in
        res = make_request_with_auth(self, '/providers',
                                     method='POST', data=bodydata)
        data = json.loads(res.data)
        ...
        res = make_request_with_auth(self, '/providers', method='POST',
                                     data=bodydata, jwt=self.adminJWT)
        data = json.loads(res.data)
    ...
    def test_add_dataset(self):
        ...
        # Test without logging in
        res = make_request_with_auth(self, '/datasets',
                                     method='POST', data=bodydata)
        data = json.loads(res.data)
        ...
        # Test logged in as normal user
        res = make_request_with_auth(self, '/datasets', method='POST',
                                     data=bodydata, jwt=self.normalJWT)
        data = json.loads(res.data)
    ...
    def test_update_provider(self):
        ...
        # Test without logging in
        res = make_request_with_auth(self, '/providers/' + provider_id,
                                     method='PATCH', data=bodydata)
        data = json.loads(res.data)
    ...
    def test_delete_provider(self):
        ...
        # Test logged in as normal user
        res = make_request_with_auth(self, '/providers/' + provider_id,
                                     method='DELETE', jwt=self.normalJWT)
        data = json.loads(res.data)
        ...
        # Test logged in as an admin
        res = make_request_with_auth(self, '/providers/' + provider_id,
                                     method='DELETE', jwt=self.adminJWT)
        data = json.loads(res.data)
